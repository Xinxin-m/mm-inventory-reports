...
- **[Exp10 - Absorbers at tick level](https://xinxin-m.github.io/mm-inventory-reports/exp10-tick-level-09-10.html)** (2026-09-10, newest) - the two multi-shock episodes second by second: single prints of $1m-$9m sweep the deep ladders; the same prints land on MMs that flatten in minutes and on MMs that hold for hours.
- **[Exp8 - Inventory shocks, redefinition](https://xinxin-m.github.io/mm-inventory-reports/exp8-inventory-shock-09-08.html)** (2026-09-08) - market taker-flow trigger, 915 events, absolute price gate, clock-time-matched controls, the whole MM population, the 148-MM profile, two tick replays with an animated book. Supersedes the v1, v2 and v3 redefinition drafts, which are archived.
